...
export const APP_FEATURES = [
  ...
  { label: 'Plan', detail: 'Build color-coded schedules and drag blocks into order.' },
  { label: 'Focus', detail: 'Run Pomodoro and deep-work timers with ambient sound.' },
  { label: 'Habits', detail: 'Track streaks with grace days — consistency beats perfection.' },
  { label: 'Insights', detail: 'Charts, sleep logs, balance tips, and reminders.' },
] as const
